...
const useTheme = () => {
  ...
  const changeTheme = (theme: string, darkMode: boolean) => {
 ...
 */
const mergeTheme = <F, G, I, L, C>(baseTheme: Theme<F, G, I, L, C>, theme: Partial<Theme<F, G, I, L, C>>, darkTheme: Partial<Theme<F, G, I, L, C>>) =>
